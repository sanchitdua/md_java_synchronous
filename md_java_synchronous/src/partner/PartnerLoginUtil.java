...
public class PartnerLoginUtil {
	...
	public PartnerConnection login(String user, String pass, String authEndPoint){
		...
		try {
			...
			System.out.println(" Warning: Cannot make the Partner Connection as the daily quota of 5,000 API calls for the SFDC account: "+user+" would have been used. Please wait until some calls become free.");
		}
			...
			while(!isDone){
				counter++;
				System.out.println("Attempting to connect "+counter+" times using Partner Connection...");
				try{
